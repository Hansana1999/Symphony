...
const Wrapper = () => {
  const data = [
    {
      path:"./Vp1",
      cateImg: "/images/Education/17.jpg",
      title: "Horn ",
      brand:"Apple",
      model:"single",
    ...
    {
      path:"./Vp2",
      cateImg: "/images/Education/18.jpg",
      title: "Air filter ",
      brand:"Apple",
      model:"single",
      decs: "You can use decorate your table Table suitable",
    ...
    {
      path:"./Vp3",
      cateImg: "/images/Education/19.jpg",
      title: "Fuel filter ",
      brand:"Apple",
      model:"single",
      decs: "You can use decorate your table Table suitable",
    ...
    {
      path:"./Vp4",
      cateImg: "/images/Education/20.jpg",
      title: "Oil filter ",
      brand:"Apple",
      model:"single",
      decs: "You can use decorate your table Table suitable",
  ...
  return (
    <>
    <h1 className= {styles.qwe3}>Note Books</h1>
    <EdCategories/>
